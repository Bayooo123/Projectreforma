...
export type Permission =
    ...
    | 'RESTORE_CALENDAR_ENTRY';

export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
    'owner': ['DELETE_BRIEF', 'EDIT_BRIEF', 'MANAGE_USERS', 'MANAGE_OFFICE', 'DELETE_MATTER', 'VIEW_FINANCIALS', 'DELETE_CLIENT', 'DELETE_CALENDAR_ENTRY', 'RESTORE_CALENDAR_ENTRY'],
    'partner': ['DELETE_BRIEF', 'EDIT_BRIEF', 'MANAGE_USERS', 'MANAGE_OFFICE', 'DELETE_MATTER', 'VIEW_FINANCIALS', 'DELETE_CLIENT', 'DELETE_CALENDAR_ENTRY'],
    'admin': ['MANAGE_USERS', 'MANAGE_OFFICE', 'DELETE_CALENDAR_ENTRY', 'RESTORE_CALENDAR_ENTRY'],
