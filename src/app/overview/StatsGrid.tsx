...
export default function StatsGrid({ metrics }: StatsGridProps) {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-violet-200/50 dark:border-violet-900/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                <div className="text-violet-600 dark:text-violet-400 text-sm font-medium mb-1">ACTIVE MATTERS</div>
            ...
            <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-orange-200/50 dark:border-orange-900/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                <div className="text-orange-600 dark:text-orange-400 text-sm font-medium mb-1">HEARINGS</div>
            ...
            <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-teal-200/50 dark:border-teal-900/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                <div className="text-teal-600 dark:text-teal-400 text-sm font-medium mb-1">INVOICES ISSUED</div>
            ...
            <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-red-300/50 dark:border-red-900/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200 relative">
                ...
                <div className="text-red-600 dark:text-red-400 text-sm font-medium mb-1">OUTSTANDING</div>
                ...
                <button className="text-xs bg-red-600 text-white px-3 py-1.5 rounded-lg hover:bg-red-700 transition-colors duration-200 font-medium">
                    Review Now
                </button>
            </div>
        </div>
...
export function StatsGridSkeleton() {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[1, 2, 3, 4].map((i) => (
                <div key={i} className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-border border/50 dark:border-slate-800 rounded-2xl p-5 h-32 animate-pulse" />
            ))}
        </div>
    );
}
